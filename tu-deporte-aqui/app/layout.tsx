...
import RateInstall from "@/components/custom/RateInstall";
...
export default function RootLayout({
  ...
  return (
    ...
    >
      <head>
        <title>Tu Deporte Aqui</title>
        <meta name="description" content="El centro digital para el deporte en Puerto Rico." />
        <meta name="apple-mobile-web-app-title" content="Tu Deporte" />
        <AppleSplashImageMetaTags />
      </head>
      <body>
...
function AppleSplashImageMetaTags() {
  return (
    <>
