...
| "Unverified report becomes confirmed" | `domain_requirements.feature` | R-DOM-4, R-DOM-1, R-DOM-1a | Andres: mark updates as preliminary or confirmed
...
| "Correction without formal announcement" | `domain_requirements.feature` | R-DOM-2, R-DOM-1, R-DOM-1a, R-DOM-3 | Sebastian: flag conflicting scores
...
| "Label unverified data from unverified sources" | `interface_requirements.feature` | R-DOM-4, R-INT-9, R-DOM-12 | Andres: avoid presenting uncertain info as definitive
| "Display source attribution in standings" | `interface_requirements.feature` | R-DOM-1, R-DOM-1a, R-DOM-12 | Sebastian: each score shows its source
...
| "Log conflicts for debugging and analysis" | `machine_requirements.feature` | R-DOM-11 | Chris: automated tests that simulate conflicting data; dashboards for consistency
...
| "Resume normal operation after source recovery" | `machine_requirements.feature` | R-MAC-7, R-MAC-9, R-INT-8 | Chris: measure availability and recovery time
| "Expose reliability metrics for monitoring" | `machine_requirements.feature` | R-INT-8 | Chris: dashboards for accuracy, consistency, availability
